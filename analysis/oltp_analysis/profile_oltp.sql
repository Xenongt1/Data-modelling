-- Performance Profiling for OLTP Queries
-- Usage: SOURCE profile_oltp.sql;

SET PROFILING = 1;

-- Q1: Monthly Encounters
SELECT "Running Q1..." AS status;
...
-- Q2: Diagnosis-Procedure Pairs
SELECT "Running Q2..." AS status;
...
-- Q4: Revenue
SELECT "Running Q4..." AS status;

SELECT DATE_FORMAT(e.encounter_date, '%Y-%m') AS month, s.specialty_name, SUM(b.allowed_amount) AS total_revenue
FROM
    billing b
